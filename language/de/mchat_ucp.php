...
$lang = array_merge($lang, array(
	...
	'MCHAT_WHOIS_INDEX'				=> 'Zeige <em>Wer chattet</em> unterhalb des Chats an',
	'MCHAT_STATS_INDEX'				=> 'Zeige <em>Wer chattet</em> in der Statistik an',
	'MCHAT_STATS_INDEX_EXPLAIN'		=> 'Zeige <em>Wer chattet</em> unterhalb von der <em>Wer ist online</em> Bereich auf dem Index an',
	...
	'MCHAT_POSTS'					=> 'Zeige neue Beiträge (aktualle alles deaktiviert, kann aber in den Globalen Einstellungen des mChat im ACP aktiviert werden)',
	'MCHAT_CHARACTER_COUNT'			=> 'Zeige Zeichenanzahl',
	'MCHAT_RELATIVE_TIME'			=> 'Zeige relative Zeit für neue Nachrichten an',
	'MCHAT_RELATIVE_TIME_EXPLAIN'	=> 'Zeige "Gerade eben", "vor einer Minute" usw. für jede Nachricht an. Setze <em>Nein</em> für die komplette Zeitanzeige.',

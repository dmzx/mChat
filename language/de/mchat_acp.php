...
$lang = array_merge($lang, array(
	...
	'MCHAT_LIVE_UPDATES_EXPLAIN'			=> 'Wenn ein Benutzer Nachrichten bearbeitet oder löscht, werden die Änderungen für alle anderen live aktualisiert, ohne dass sich die Seite neu lädt. Deaktivieren Sie diese Option, wenn Leistungsprobleme auftreten.',
	...
	'MCHAT_EDIT_DELETE_LIMIT_EXPLAIN'		=> 'Nachrichten, die älter als die angegebene Anzahl von Sekunden können vom Autor nicht mehr bearbeitet oder gelöscht werden.<br />Benutzer, die <em>bearbeiten/löschen</em> dürfen sind von dieser Frist befreit. <br /> Bei 0 wird unbegrenztes Bearbeiten und Löschen ermöglicht.',

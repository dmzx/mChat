...
$lang = array_merge($lang, array(
	...
	'MCHAT_SETTINGS_PRUNE'							=> 'Bereinigung Einstellungen',
	'MCHAT_SETTINGS_STATS'							=> 'Wer ist im Chat Einstellungen',

	'MCHAT_GLOBALUSERSETTINGS_EXPLAIN'				=> 'Einstellungen, für die ein Benutzer <strong>keine</ strong> Berechtigung hat sie anzupassen, sind wie folgt vordefiniert.<br />Neue Benutzer bekommen die vordefinierten Einstellungen zugewiesen. <br /><br />Gehe zum <em>mChat im UCP</em> Reiter im persönlichen Bereich um die persönlichen Einstellungen vorzunehmen.<br />Gehe in den <em>Benutzerrechte</em> Reiter der <em>Benutzereinstellungen</em> um die aktuellen Einstellungen jedes einzelnen Mitglieds zu sehen.',
	'MCHAT_GLOBALUSERSETTINGS_OVERWRITE'			=> 'Überschreibe alle Benutzer Einstellungen',
	'MCHAT_GLOBALUSERSETTINGS_OVERWRITE_EXPLAIN'	=> 'Die hier eingestellten Werte werden für <em>alle</em> Benutzer überschrieben.',
	'MCHAT_GLOBALUSERSETTINGS_OVERWRITE_CONFIRM'	=> 'Bestätige, daß Du die mChat Einstellungen für alle Benutzer überschreiben möchtest.',
	...
	// ACP settings
	'MCHAT_ACP_GLOBALSETTINGS_TITLE'				=> 'mChat Allgemeine Einstellungen',
	'MCHAT_ACP_GLOBALUSERSETTINGS_TITLE'			=> 'mChat Allgemeine Benutzer Einstellungen',
	'MCHAT_VERSION'									=> 'Version',
	'MCHAT_RULES'									=> 'Regeln',
	'MCHAT_RULES_EXPLAIN'							=> 'Gib Deine Regeln hier ein. Jede Regel in eine neue Zeile. HTML-code ist erlaubt.<br />Lass das Feld frei um die Anzeige zu deaktivieren. Das Limit liegt bei 255 Zeichen.<br /><strong>Diese Nachricht kann übersetzt werden.</strong> (editiere hierzu die Datei: /ext/dmzx/mchat/language/XX/mchat.php und passe die Variable MCHAT_RULES_MESSAGE an).',
	...
	'MCHAT_INDEX_HEIGHT'							=> 'Höhe der Chat Box',
	...
	'MCHAT_CUSTOM_HEIGHT'							=> 'Höhe der Chat Box',
	...
	'MCHAT_WHOIS_REFRESH'							=> 'Wer ist im Chat aktualisieren',
	'MCHAT_WHOIS_REFRESH_EXPLAIN'					=> 'Die Anzahl Sekunden, bis die "Wer ist im Chat" Anzeige aktualisiert wird.<br /><em>Du kannst nur zwischen 10 und 300 Sekunden einstellen. Standardwert ist 60.</em>',

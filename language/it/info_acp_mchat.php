...
$lang = array_merge($lang, array(
	...
	'MCHAT_CUSTOM_DATEFORMAT'		=> 'Personalizzata…',
	'MCHAT_WHOIS'					=> 'Dettagli',
	'MCHAT_WHOIS_EXPLAIN'			=> 'Mostra elenco utenti che sono in chat',
	...
	'MCHAT_OVERRIDE_SMILIE_LIMIT_EXPLAIN'	=> 'Impostare su SI per ignorare le impostazioni del limite di smile nella chat',
	'MCHAT_OVERRIDE_MIN_POST_CHARS'	=> 'Ignora limite minimo di caratteri',
	'MCHAT_OVERRIDE_MIN_POST_CHARS_EXPLAIN'	=> 'Impostare su SI per ignorare i caratteri minimi dei messaggi della chat',
	'MCHAT_NEW_POSTS'				=> 'Abilita la visualizzazione dei nuovi messaggi',
	'MCHAT_NEW_POSTS_EXPLAIN'		=> 'Metti SI se vuoi visualizzare nella chat i nuovi messaggi del forum.',
	'MCHAT_NEW_POSTS_TOPIC'				=> 'Visualizza nuovi Messaggi e nuovi Argomenti',
	'MCHAT_NEW_POSTS_TOPIC_EXPLAIN'		=> 'Impostare su SI per consentire a mChat di pubblicare i nuovi messaggi e argomenti del forum nella chat.',
	'MCHAT_NEW_POSTS_REPLY'				=> 'Visualizza nuovi messaggi',
	'MCHAT_NEW_POSTS_REPLY_EXPLAIN'		=> 'Impostare su SI per consentire la visualizzazione delle risposte agli Argomenti del forum nella chat.',
	'MCHAT_NEW_POSTS_EDIT'				=> 'Visualizza i messaggi modificati',
	'MCHAT_NEW_POSTS_EDIT_EXPLAIN'		=> 'Impostare su SI per consentire che i messaggi modificati siano pubblicati nella chat.',
	'MCHAT_NEW_POSTS_QUOTE'				=> 'Visualizza messaggi con citazione',
	'MCHAT_NEW_POSTS_QUOTE_EXPLAIN'		=> 'Impostare su Sì per consentire al messaggio citato di essere pubblicato nella chat',
	'MCHAT_MAIN'					=> 'Configurazione',
	...
	'MCHAT_PAUSE_ON_INPUT_EXPLAIN'	=> 'Se impostato SI, allora la chat non verrà aggiornata automaticamente mentre un utente inserisce un messaggio nella chat',
	...
	'TOO_SMALL_FLOOD_TIME'	=> 'Il valore del tempo per il flood è troppo breve.',
	'TOO_LARGE_FLOOD_TIME'	=> 'Il valore del tempo per il flood è troppo grande.',
	...
	'ACL_U_MCHAT_PM'			=> 'Può usare messaggi privati in mChat',
	'ACL_U_MCHAT_LIKE'			=> 'Può usare mi piace in mChat',
	'ACL_U_MCHAT_QUOTE'			=> 'Può quotare messaggio in mChat',
